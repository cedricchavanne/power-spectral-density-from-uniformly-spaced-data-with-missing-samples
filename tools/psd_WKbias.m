function [P,f] = psd_WKbias(x,varargin)

% [P,f] = psd_WKbias(x,y)
% Computes the power cross-spectral density P of the data series x and y
% using Wiener-Khinchin's theorem with the biased estimator
...
% P is corrected for the energy loss due to the missing data.
...
% biased standard cross-correlation
c = xcorrbias(x,y); 
